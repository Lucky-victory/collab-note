...
import type { MemberForAvatar } from "@/types";

import styles from "./Avatars.module.css";

const SelfAvatar = ({ self }: { self: MemberForAvatar | null }) => {
...
const Avatars = ({
  ...
  otherUsers: MemberForAvatar[];
  self: MemberForAvatar | null;
}) => {
